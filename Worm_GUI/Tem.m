function varargout = Tem(varargin)
% TEM M-file for Tem.fig
%      TEM, by itself, creates a new TEM or raises the existing
%      singleton*.
%
%      H = TEM returns the handle to a new TEM or the handle to
%      the existing singleton*.
%
%      TEM('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TEM.M with the given input arguments.
%
%      TEM('Property','Value',...) creates a new TEM or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Tem_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Tem_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Tem

% Last Modified by GUIDE v2.5 02-Apr-2015 17:16:43

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Tem_OpeningFcn, ...
                   'gui_OutputFcn',  @Tem_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Tem is made visible.
function Tem_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Tem (see VARARGIN)

% Choose default command line output for Tem
...
% UIWAIT makes Tem wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Tem_OutputFcn(hObject, eventdata, handles) 
...
%            angle_store(count)=-pi/18.0;
       ...
       %%¡ì¡ì¡§
       sita=cal_grad(xx_t(size_y),yy_t(size_y));%¡ì¡ì2¡§
