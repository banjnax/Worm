...
% GRAD M-file for Grad.fig
%      GRAD, by itself, creates a new GRAD or raises the existing
%      singleton*.
%
%      H = GRAD returns the handle to a new GRAD or the handle to
%      the existing singleton*.
%
%      GRAD('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GRAD.M with the given input arguments.
%
%      GRAD('Property','Value',...) creates a new GRAD or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Grad_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Grad_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Grad

% Last Modified by GUIDE v2.5 02-Apr-2015 17:19:57

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Grad_OpeningFcn, ...
                   'gui_OutputFcn',  @Grad_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Grad is made visible.
function Grad_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Grad (see VARARGIN)

% Choose default command line output for Grad
set(handles.popupmenu1,'string',{'Gauss-1','Gauss-2','Gauss-3'});
axes(handles.axes1);
...
% UIWAIT makes Grad wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Grad_OutputFcn(hObject, eventdata, handles) 
...
while 1
   ...
   hold on
    ...
    for ii=1:size_y
     ...
     zt2=zt3;
     zt1=cal_T_v2(xx_t(size_y),yy_t(size_y),handles.pic,best_T);%¡ì¡ì
     zt3=cal_T_v2(coor_S(size_y,1),coor_S(size_y,2),handles.pic,best_T);%¡§¡ì¡ì¡§
...
%        end
       ...
       if (current_count+1)==last_count
           ...
           if current_count==4
                 delta_T_multi=delta_T_multi+1;%¡ì¡ì3
                   if delta_T_multi==9
                       delta_T_multi=1;
                   end
       ...
       judge=cross(v_t,v_t2);%¡§¡ì¡ì¡ì¡ì¡§¡§¡ì¡ì¡§¡§,z¡§0¡§,z0
       if judge(3)>0
           %sita=sita+ran_angle;%¡§¡§¡ì¡ì1
            sita=sita+pi/18.0*delta_T_multi;%¡§¡§¡ì¡ì3
            sita=mod(sita,2*pi);
%           ran_angle
%            count 
%            Mem
...
%            angle_store(count)=-pi/18.0;
       ...
       %%¡ì¡ì¡§
       sita=cal_grad_v2(xx_t(size_y),yy_t(size_y),handles.pic);%¡ì¡ì2¡§
   ...
   Mem_grad(count)=cal_grad_v2(xx_t(size_y),yy_t(size_y),handles.pic);
