...
% Last Modified by GUIDE v2.5 10-Apr-2015 21:31:42
...
%            angle_store(count)=-pi/18.0;
       ...
       %%§§¨
       %%sita=cal_grad_v2(xx_t(size_y),yy_t(size_y),handles.pic,handles.fps);%§§2¨
        P=[xx_t(size_y);yy_t(size_y)];
        A=sim(net,P);
        temT=A(1)/(sqrt(A(1)^2+A(2)^2));
        sita=acos(temT);
...
function  net=Train_Net(handles)
clc
[P T]=generate(handles);
