function varargout = Economy(varargin)
% ECONOMY M-file for Economy.fig
%      ECONOMY, by itself, creates a new ECONOMY or raises the existing
%      singleton*.
%
%      H = ECONOMY returns the handle to a new ECONOMY or the handle to
%      the existing singleton*.
%
%      ECONOMY('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ECONOMY.M with the given input arguments.
%
%      ECONOMY('Property','Value',...) creates a new ECONOMY or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Economy_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Economy_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Economy

% Last Modified by GUIDE v2.5 10-Apr-2015 19:10:48

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Economy_OpeningFcn, ...
                   'gui_OutputFcn',  @Economy_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Economy is made visible.
function Economy_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Economy (see VARARGIN)

% Choose default command line output for Economy
...
% UIWAIT makes Economy wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Economy_OutputFcn(hObject, eventdata, handles) 
